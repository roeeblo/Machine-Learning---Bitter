...
## Overview
This project focuses on analyzing a **Bitter csv**, which contains information about various compounds and their bitterness levels. The goal is to explore the dataset, preprocess the data, normalize the dataset, in the most precise way possible.
